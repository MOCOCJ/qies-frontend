...
public class ServiceNumber extends RecordElement {
    ...
    // This constructor is for the Agent/Planner to validate the String with the valid-service-list.txt
    public ServiceNumber(String number, SessionManager manager) {
        if (isContained(number, manager)) {
            this.number = number;
            this.isSet = true;
        } else {
    ...
    // This constructor is to check tempService in the isContained method as well as ValidServiceList constructor set up
